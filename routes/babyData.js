  ...
  Baby.findById(id).then((baby) => {
    ...
    return newAlimentation
      ...
      .then(() => {
        res
          .status(200)
          .json({ message: "Alimentation enregistrée", data: newAlimentation });
      });
  });
});
  ...
  Baby.findById(id).then((baby) => {
    ...
    return newElimination
      ...
      .then(() => {
        res
          .status(200)
          .json({ message: "Elimination enregistrée", data: newElimination });
      });
  });
});
  ...
  Baby.findById(id).then((baby) => {
    ...
    return newTemperature
      ...
      .then(() => {
        res
          .status(200)
          .json({ message: "temperature enregistrée", data: newTemperature });
      });
  });
});
